  ...
  return (
    ...
    >
      <div className={`tile ${isRevealed ? 'flipped' : ''}`}>
        {/* Front face */}
        <div
          className={`tile-face flex items-center justify-center font-bold font-mono uppercase select-none
        ...
        {/* Back face (revealed) */}
        <div
          className={`tile-face tile-back flex items-center justify-center font-bold font-mono uppercase select-none
